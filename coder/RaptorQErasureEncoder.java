...
/**
 * RaptorQ erasure encoder that encodes a block group.
 *
 * RaptorQ is a fountain code that can generate unlimited parity symbols.
 * This encoder uses the OpenRQ library for the core RaptorQ algorithm.
 *
 * It implements {@link ErasureCoder}.
 */
@InterfaceAudience.Private
public class RaptorQErasureEncoder extends ErasureEncoder {

  public RaptorQErasureEncoder(ErasureCoderOptions options) {
    super(options);
  }
