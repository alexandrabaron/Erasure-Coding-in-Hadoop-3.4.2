...
/**
 * RaptorQ erasure decoder that decodes a block group.
 *
 * RaptorQ is a fountain code that can recover data from any subset of symbols.
 * This decoder uses the OpenRQ library for the core RaptorQ algorithm.
 *
 * It implements {@link ErasureCoder}.
 */
@InterfaceAudience.Private
public class RaptorQErasureDecoder extends ErasureDecoder {

  public RaptorQErasureDecoder(ErasureCoderOptions options) {
    super(options);
  }
